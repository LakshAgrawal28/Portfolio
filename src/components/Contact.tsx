        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full">
          {contactOptions.map((item, i) => (
            <motion.a
              ...
              whileHover={{ y: -10 }}
              className={`p-8 border-2 transition-all duration-500 block hide-cursor-on-desktop pointer-events-auto relative
                ${era === '1800s' ? 'border-accent/40 rounded-none bg-accent/5 font-serif hover:bg-accent/20' : 
                  ...
                  'border-accent/25 bg-black/40 text-accent rounded-none hover:border-accent/60 hover:shadow-[0_0_30px_rgba(6,182,212,0.2)]'}
              `}
            >

          ...
          <AnimatePresence mode="popLayout">
            {data.projects.map((project) => (
              ...
              >
                {/* Card Base */}
                <div className={cn(
                  "h-full bg-surface border-2 transition-all duration-700 overflow-hidden flex flex-col backdrop-blur-sm",
                  era === '1800s' && "border-accent/30 rounded-none shadow-[10px_10px_0_rgba(251,191,36,0.1)] hover:shadow-none hover:translate-x-[5px] hover:translate-y-[5px]",
                  ...
                  era === 'future' && "border-accent/20 rounded-none clip-path-polygon hover:border-accent hover:bg-accent/5 shadow-[0_0_40px_rgba(6,185,129,0.08)]"
                )}>
                    ...
                    <div className="flex gap-3">
                      <motion.a 
                        ...
                        className={cn(
                          ...
                          era === 'future' && "border border-quantum/40 text-quantum hover:bg-quantum/20 clip-path-polygon"
                        )}
                        target="_blank"
                        rel="noreferrer"
                      >
                      ...
                      <motion.a 
                        ...
                        className={cn(
                          ...
                          era === 'future' && "bg-quantum text-white clip-path-polygon shadow-[0_0_15px_rgba(139,92,246,0.3)] quantum-shimmer"
                        )}
                        target="_blank"
                        rel="noreferrer"
                      >
